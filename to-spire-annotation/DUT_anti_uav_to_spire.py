...
def main():
    ...
    parser.add_argument(
        "--dut-anno",
        default="E:\\dataset\\IEEE_TITS_Drone\\test\\xml",
        help="path to DUT Anti-UAV annotation file",
    )
    parser.add_argument(
        "--dut-image-dir",
        default="E:\\dataset\\IEEE_TITS_Drone\\test\\img",
        help="path to DUT Anti-UAV image dir",
    )
    parser.add_argument(
        "--output-dir",
        default="E:\\dataset\\IEEE_TITS_Drone\\Spire-test",
